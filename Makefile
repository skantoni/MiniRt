...
SRC = src/main.c src/windows/create_win.c src/parser/parse_minirt.c src/parser/parse_minirt_utils.c src/parser/print_error.c src/get_next_line/get_next_line_utils.c src/get_next_line/get_next_line.c
